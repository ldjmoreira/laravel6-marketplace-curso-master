...
Route::resource('usuarios', 'usuariosController');// é resource pq o controlador foi criado usando o comando resource
...
Route::group(['middleware' => ['auth', 'access.control.store.admin']], function(){//aqui estão as rotas protegidas

	Route::prefix('admin')->name('admin.')->namespace('Admin')->group(function(){//prefix adiciona caminho na rota
